...
<html lang="es">
 ...
 <div class="container">
   ...
   <option value="<?php echo $apellidodirigente ['id'];?>"><?php echo $apellidodirigente['apellido'];?></option>
   ...
   <?php endforeach; ?>     
    ...
    <?php
        ...
        $sqldirigente ="SELECT dirigente.id, dirigente.apellido, empleados.apellido, empleados.nombre, empleados.direccion, empleados.circuito 
        from empleados 
        inner join dirigente on empleados.dirigente=dirigente.apellido  WHERE dirigente = $dirigenteseleccionado ";
    ...
    <table>
            ...
            <tbody>
                <?php
                    while ($registro =$dirigenteseleccionado->fetch_array(MYSQLI_BOTH) ){
                        echo "<tr>
                                    <td>".$registro['dni']."</td>
        ...
        <?php
         ...
         <table class="table table-hover">
            ...
            <tbody>
                <tr>
                    <td colspan="3">
                        <div class="alert alert-danger" roles="alert"> Sin Datos</div>
          </td>
          </tr>
          </tbody>
        </table>
